...
global outfolder="$outfolder STAY_LABOR_EIN"
...
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
do "$maindirectory${sep}do${sep}Gen_Labor_Sample_3EIN.do"


do "$maindirectory${sep}do${sep}bymydiststat2.do"
do "$maindirectory${sep}do${sep}bymyxtile.do"
global YRCHANGE="$maindirectory${sep}do${sep}YRCHG_LABOR_EIN.do"
