...
global outfolder="$outfolder YRCHANGE_LABOR_DIB"
...
global YRCHANGE="$maindirectory${sep}do${sep}YRCHANGE_LABOR_DIB.do"
...
use L1.dta, clear
collapse (mean) p1reslaborch-maxresAtotincch, by(agebin pastincpct)
